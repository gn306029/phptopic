<?php
	...
	if(isset($_POST['REGISTER_ACCOUNT'],$_POST['REGISTER_PASSWORD'],$_POST['REGISTER_NAME'],$_POST['REGISTER_BIRTHDAY'],$_POST['REGISTER_EMAIL'],$_POST['REGISTER_PHONE_NUM'],$_POST['REGISTER_GENDER'],$_POST['REGISTER_JOB'],$_POST['REGISTER_CATEGORY'])){
