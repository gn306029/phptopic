...
<?php
     ...
     *
     */
	$stmt=$conn->query("SELECT DISTINCT A.CATEGORY_ID, B.CATEGORY_NAME FROM VIDEO A JOIN CATEGORY B ON A.CATEGORY_ID=B.CATEGORY_ID where a.KIND_ID=3");
	/*
     * 預設頁數
     *
     */
     ...
     */
    if($now_pages == 1){
		$table .= "<tr><td colspan='8' align='center'>".$page_list."<a href='./Page_Drama.php?page=".($now_pages+1)."&search=".$_GET['search']."&kind=3&category=".$_GET['category']."'>下一頁</a></td></tr>";
    }else if($now_pages == $all_num){
		$table .= "<tr><td colspan='8' align='center'><a href='./Page_Drama.php?page=".($now_pages-1)."&search=".$_GET['search']."&kind=3&category=".$_GET['category']."'>前一頁</a>".$page_list."</td></tr>";
    }else{
        $table .= "<tr><td colspan='8' align='center'><a href='./Page_Drama.php?page=".($now_pages-1)."&search=".$_GET['search']."&kind=3&category=".$_GET['category']."'>前一頁</a>".$page_list." <a href='./Page_Drama.php?page=".($now_pages+1)."&search=".$_GET['search']."&kind=3&category=".$_GET['category']."'>下一頁</a></td></tr>";
    }
?>
    ...
    <script type="text/javascript">
        ...
        $(function(){
            $("#select_page").change(function(){
                window.location = "./Page_Drama.php?page="+$(this).val()+"&search="+url("?search")+"&kind="+url("?kind")+"&category="+url("?category");
            })
        })
    </script>
</head>
