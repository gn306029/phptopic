$(function(){
            ...
            $("body").on("click","#update",function () {
                ...
                infor_html += "會員密碼：<input type='password' name='member_password' value='"+$("#user_password").text()+"'></br>";
                ...
                infor_html += "手機：<input type='text' name='member_phone_num' value='"+$("#user_phone_num").text()+"'></br>";
